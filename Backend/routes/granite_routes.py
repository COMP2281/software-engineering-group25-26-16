...
@router.get("/{warning_id}", response_class=StreamingResponse, response_model=None)
def explain_diagnostics(
    ...
    return StreamingResponse(granite_service.generate_explanation_for_warning(warning_id, query, db), media_type="text/plain")
